...
show menu
******************************************************************************/
function show_menu(contractCodeHash) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        consts.BOX.key('enter', function () {
            return __awaiter(this, void 0, void 0, function* () {
                dialog.hidden = !dialog.hidden;
                if (!dialog.hidden) {
                    choice = parseInt(yield h.get_input(dialog));
                    if (isNaN(choice)) {
                        ...
                        choice = choice;
                        let pool_info_result = yield query.pool_info(contractCodeHash, choice);
              ...
              \n\t{bold}number of players: ${p_info.player_cap}{/}\n{green-fg}confirm?{/} (y/N) `;
                            ...
                            let confirm = yield h.get_input(dialog);
                            if (confirm == 'y') {
